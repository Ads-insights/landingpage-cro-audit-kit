...
- [concrete research step, e.g. "session recordings of 50+ PDP sessions to see where users drop off"]
- [concrete research step, e.g. "5-second test on current hero image to validate clarity of product"]
```
