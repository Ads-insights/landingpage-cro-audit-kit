...
- **ICE:** I=7, C=8, E=9 → 8.0
- **Source:** [Baymard Institute / Nielsen Norman / Cialdini / specific study]
```
...
- [concrete research step, e.g. "session recordings of 50+ category page sessions to see filter usage patterns"]
- [concrete research step, e.g. "click-map analysis on current filter sidebar to identify dead zones"]
```

This keeps the report honest. False precision is worse than acknowledged uncertainty.

For quality calibration, read `references/finding-examples.md` to see how well-structured category page findings are written.
