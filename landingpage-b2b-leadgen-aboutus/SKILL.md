...
**Diagnosis**
What is wrong and why it matters according to [specific B2B-aboutus or trust principle / source].
Concrete observation from the page or screenshot.

**Recommendation**
Concrete action. For copy: exact alternative text. For leadership-photos: specific layout / style guidance. For milestones: specific timeline format.
...
- **ICE:** I=6, C=7, E=8 → 7.0
- **Source:** [Edelman B2B Trust / Forrester / Cialdini / specific study]
```
...
## Category sweep
[One-line status per category: Findings (critical/important/nice) / No findings — [brief reason] / Not assessable — [reason]. Note: Company-size & footprint signals may be marked "Not material" for MKB-B2B / small consultancy; Values & culture often "checked, brief observation" for corporate B2B.]
...
[Max 4 sprints. Note that B2B aboutus test-windows are typically LONGER than other B2B page-types due to lower direct-conversion attribution — count on 6-10 weken voor meaningful signal. Downstream MQL/SQL attribution takes much longer.]

## Audit limitations
[3-6 bullets. Must include: aboutus-page impact is harder to attribute than direct-conversion B2B pages — recommendations are directional, not numerically precise.]
...
**.docx structure:** cover page (with B2B-service-type + organization-size + founder-led-vs-corporate), samenvatting, category sweep, findings grouped by priority, test roadmap, audit limitations.
