...
- **ICE:** I=7, C=8, E=9 → 8.0
- **Source:** [CXL form research / Cialdini / Spiegel / specific study]
```
...
[Max 4 sprints. Note that leadgen test measurement windows depend heavily on traffic volume — low-traffic service pages may need 4-8 weken per test.]
...
**.docx structure:** cover page (with leadgen-type), samenvatting, category sweep, findings grouped by priority, test roadmap, audit limitations.
